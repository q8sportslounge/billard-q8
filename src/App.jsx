      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: 560, margin: "0 auto", padding: "32px 20px 60px" }}>
        ...
        {!submitted ? (
          ...
          <div style={{ textAlign: "center", padding: "40px 20px" }}>
            ...
            <h2 style={{ fontSize: "2rem", fontWeight: 900, margin: "0 0 12px", textTransform: "uppercase", fontFamily: "'Phudu', sans-serif" }}>Buchung<br /><span style={{ color: "#4a9c2f" }}>Bestätigt!</span></h2>
            <p style={{ color: "#888", fontFamily: "sans-serif", fontSize: 14, lineHeight: 1.7, marginBottom: 32 }}>
              Hey {form.name}! Deine Buchung ist eingegangen und vollständig bezahlt ✓<br />
